---
title: 在 Azure 上建置微服務
description: 在 Azure 上設計、建置及操作微服務架構
ms.date: 03/07/2019
layout: LandingPage
...
ms.locfileid: "58346139"
---
# <a name="building-microservices-on-azure"></a>在 Azure 上建置微服務

<!-- markdownlint-disable MD033 -->

<img src="../_images/microservices.svg" style="float:left; margin-top:8px; margin-right:8px; max-width: 80px; max-height: 80px;"/>

微服務是熱門的架構樣式，用於建置可復原、高延展性、可獨立部署，以及能夠快速發展的應用程式。 但是成功的微服務架構需要不同的方法來設計和建置應用程式。
...
## <a name="examples-of-microservices-architectures"></a>微服務架構的範例
...
## <a name="build-a-microservices-application"></a>建置微服務應用程式
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardText">
                        <h3>使用領域分析進行微服務建模</h3>
                        <p>若要在設計微服務時避免一些常見陷阱，請使用領域分析來定義您的微服務界限。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="../reference-architectures/microservices/aks.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardText">
                        <h3>Azure Kubernetes Services (AKS) 的參考架構</h3>
                        <p>此參考架構顯示的基本 AKS 組態可作為大多數部署的起點。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="../reference-architectures/microservices/service-fabric.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardText">
                        <h3>Azure Service Fabric 的參考架構</h3>
                        <p>此參考架構顯示的建議組態可作為大多數部署的起點。</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardText">
                        <h3>設計微服務架構</h3>
                        <p>這些文章深入探討如何根據使用 Azure Kubernetes Service (AKS) 的參考實作來建置微服務應用程式。</p>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="operate-microservices-in-production"></a>在生產環境中操作微服務
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardText">
                        <h3>持續整合及部署</h3>
                        <p>持續整合與持續傳遞 (CI/CD) 是透過微服務獲致成功的關鍵。</p>
                    </div>
                </div>
            </div>
        </div>
