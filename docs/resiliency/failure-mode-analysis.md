...
- <span data-ttu-id="c2106-137">如果是預期性關閉，請使用應用程式的關閉事件來正常關閉。</span><span class="sxs-lookup"><span data-stu-id="c2106-137">If the shutdown was expected, use the application's shutdown event to shut down gracefully.</span></span> <span data-ttu-id="c2106-138">例如，在 ASP.NET 中使用 `Application_End` 方法。</span><span class="sxs-lookup"><span data-stu-id="c2106-138">For example, in ASP.NET, use the `Application_End` method.</span></span>
...
<span data-ttu-id="c2106-156">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-156">**Diagnostics**.</span></span> <span data-ttu-id="c2106-157">記錄所有驗證要求。</span><span class="sxs-lookup"><span data-stu-id="c2106-157">Log all authentication requests.</span></span>
...
<span data-ttu-id="c2106-174">**復原：**</span><span class="sxs-lookup"><span data-stu-id="c2106-174">**Recovery:**</span></span>
...
<span data-ttu-id="c2106-192">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-192">**Detection**.</span></span> <span data-ttu-id="c2106-193">捕捉 `Microsoft.Rest.Azure.CloudException` 錯誤。</span><span class="sxs-lookup"><span data-stu-id="c2106-193">Catch `Microsoft.Rest.Azure.CloudException` errors.</span></span>
...
<span data-ttu-id="c2106-215">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-215">**Diagnostics**.</span></span> <span data-ttu-id="c2106-216">應用程式記錄檔</span><span class="sxs-lookup"><span data-stu-id="c2106-216">Application logs</span></span>
...
<span data-ttu-id="c2106-262">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-262">**Diagnostics**.</span></span> <span data-ttu-id="c2106-263">記錄用戶端上的所有錯誤。</span><span class="sxs-lookup"><span data-stu-id="c2106-263">Log all errors on the client side.</span></span>
...
- <span data-ttu-id="c2106-280">使用重試機制。</span><span class="sxs-lookup"><span data-stu-id="c2106-280">Use a retry mechanism.</span></span> <span data-ttu-id="c2106-281">每個用戶端都有自己的重試原則。</span><span class="sxs-lookup"><span data-stu-id="c2106-281">Each client has its own retry policies.</span></span>
...
<span data-ttu-id="c2106-316">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-316">**Diagnostics**.</span></span> <span data-ttu-id="c2106-317">使用 [Redis 快取診斷][redis-monitor]。</span><span class="sxs-lookup"><span data-stu-id="c2106-317">Use [Redis Cache diagnostics][redis-monitor].</span></span>
...
- <span data-ttu-id="c2106-334">若為查詢，讀取次要複本。</span><span class="sxs-lookup"><span data-stu-id="c2106-334">For queries, read from a secondary replica.</span></span>
...
### <a name="writing-a-message-to-a-service-bus-queue-fails"></a><span data-ttu-id="c2106-376">將訊息寫入服務匯流排佇列時失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-376">Writing a message to a Service Bus queue fails.</span></span>
...
<span data-ttu-id="c2106-419">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-419">**Diagnostics**.</span></span> <span data-ttu-id="c2106-420">記錄重複的訊息。</span><span class="sxs-lookup"><span data-stu-id="c2106-420">Log duplicated messages.</span></span>
...
<span data-ttu-id="c2106-439">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-439">**Detection**.</span></span> <span data-ttu-id="c2106-440">服務會傳回錯誤。</span><span class="sxs-lookup"><span data-stu-id="c2106-440">The service returns an error.</span></span>
...
### <a name="writing-data-to-azure-storage-fails"></a><span data-ttu-id="c2106-461">將資料寫入 Azure 儲存體時失敗</span><span class="sxs-lookup"><span data-stu-id="c2106-461">Writing data to Azure Storage fails</span></span>
...
<span data-ttu-id="c2106-485">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-485">**Diagnostics**.</span></span> <span data-ttu-id="c2106-486">使用[儲存體度量][storage-metrics]。</span><span class="sxs-lookup"><span data-stu-id="c2106-486">Use [storage metrics][storage-metrics].</span></span>
...
<span data-ttu-id="c2106-504">**復原**。</span><span class="sxs-lookup"><span data-stu-id="c2106-504">**Recovery**.</span></span> <span data-ttu-id="c2106-505">對每個應用程式層，在相同的可用性設定組內放入多個 VM 執行個體，並在 VM 前放置負載平衡器。</span><span class="sxs-lookup"><span data-stu-id="c2106-505">For each application tier, put multiple VM instances into the same availability set, and place a load balancer in front of the VMs.</span></span> <span data-ttu-id="c2106-506">如果健康情況探查失敗，負載平衡器會停止傳送新的連線至狀況不良的執行個體。</span><span class="sxs-lookup"><span data-stu-id="c2106-506">If the health probe fails, the Load Balancer stops sending new connections to the unhealthy instance.</span></span>

<span data-ttu-id="c2106-507">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-507">**Diagnostics**.</span></span> <span data-ttu-id="c2106-508">- 使用負載平衡器[記錄分析][lb-monitor]。</span><span class="sxs-lookup"><span data-stu-id="c2106-508">- Use Load Balancer [log analytics][lb-monitor].</span></span>

- <span data-ttu-id="c2106-509">設定您的監視系統來監視所有的健康情況監視端點。</span><span class="sxs-lookup"><span data-stu-id="c2106-509">Configure your monitoring system to monitor all of the health monitoring endpoints.</span></span>

### <a name="operator-accidentally-shuts-down-a-vm"></a><span data-ttu-id="c2106-510">操作員不小心關閉 VM。</span><span class="sxs-lookup"><span data-stu-id="c2106-510">Operator accidentally shuts down a VM.</span></span>

<span data-ttu-id="c2106-511">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-511">**Detection**.</span></span> <span data-ttu-id="c2106-512">N/A</span><span class="sxs-lookup"><span data-stu-id="c2106-512">N/A</span></span>

<span data-ttu-id="c2106-513">**復原**。</span><span class="sxs-lookup"><span data-stu-id="c2106-513">**Recovery**.</span></span> <span data-ttu-id="c2106-514">使用 `ReadOnly` 層級設定資源鎖定。</span><span class="sxs-lookup"><span data-stu-id="c2106-514">Set a resource lock with `ReadOnly` level.</span></span> <span data-ttu-id="c2106-515">請參閱[使用 Azure Resource Manager 鎖定資源][rm-locks]。</span><span class="sxs-lookup"><span data-stu-id="c2106-515">See [Lock resources with Azure Resource Manager][rm-locks].</span></span>

<span data-ttu-id="c2106-516">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-516">**Diagnostics**.</span></span> <span data-ttu-id="c2106-517">使用 [Azure 活動記錄][azure-activity-logs]。</span><span class="sxs-lookup"><span data-stu-id="c2106-517">Use [Azure Activity Logs][azure-activity-logs].</span></span>

## <a name="webjobs"></a><span data-ttu-id="c2106-518">WebJobs</span><span class="sxs-lookup"><span data-stu-id="c2106-518">WebJobs</span></span>

### <a name="continuous-job-stops-running-when-the-scm-host-is-idle"></a><span data-ttu-id="c2106-519">SCM 主機閒置時，連續作業停止執行。</span><span class="sxs-lookup"><span data-stu-id="c2106-519">Continuous job stops running when the SCM host is idle.</span></span>

<span data-ttu-id="c2106-520">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-520">**Detection**.</span></span> <span data-ttu-id="c2106-521">將取消權杖傳遞給 WebJob 函式。</span><span class="sxs-lookup"><span data-stu-id="c2106-521">Pass a cancellation token to the WebJob function.</span></span> <span data-ttu-id="c2106-522">如需詳細資訊，請參閱[正常關機][web-jobs-shutdown]。</span><span class="sxs-lookup"><span data-stu-id="c2106-522">For more information, see [Graceful shutdown][web-jobs-shutdown].</span></span>

<span data-ttu-id="c2106-523">**復原**。</span><span class="sxs-lookup"><span data-stu-id="c2106-523">**Recovery**.</span></span> <span data-ttu-id="c2106-524">在 Web 應用程式中啟用 `Always On` 設定。</span><span class="sxs-lookup"><span data-stu-id="c2106-524">Enable the `Always On` setting in the web app.</span></span> <span data-ttu-id="c2106-525">如需詳細資訊，請參閱[使用 WebJobs 執行背景工作][web-jobs]。</span><span class="sxs-lookup"><span data-stu-id="c2106-525">For more information, see [Run Background tasks with WebJobs][web-jobs].</span></span>

## <a name="application-design"></a><span data-ttu-id="c2106-526">應用程式設計</span><span class="sxs-lookup"><span data-stu-id="c2106-526">Application design</span></span>

### <a name="application-cant-handle-a-spike-in-incoming-requests"></a><span data-ttu-id="c2106-527">應用程式無法處理內送要求突然增加。</span><span class="sxs-lookup"><span data-stu-id="c2106-527">Application can't handle a spike in incoming requests.</span></span>

<span data-ttu-id="c2106-528">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-528">**Detection**.</span></span> <span data-ttu-id="c2106-529">視應用程式而定。</span><span class="sxs-lookup"><span data-stu-id="c2106-529">Depends on the application.</span></span> <span data-ttu-id="c2106-530">一般徵兆：</span><span class="sxs-lookup"><span data-stu-id="c2106-530">Typical symptoms:</span></span>

- <span data-ttu-id="c2106-531">網站開始傳回 HTTP 5xx 錯誤碼。</span><span class="sxs-lookup"><span data-stu-id="c2106-531">The website starts returning HTTP 5xx error codes.</span></span>
- <span data-ttu-id="c2106-532">相依服務 (例如資料庫或儲存體) 開始對要求進行節流。</span><span class="sxs-lookup"><span data-stu-id="c2106-532">Dependent services, such as database or storage, start to throttle requests.</span></span> <span data-ttu-id="c2106-533">根據服務尋找 HTTP 錯誤，例如 HTTP 429 (太多要求)。</span><span class="sxs-lookup"><span data-stu-id="c2106-533">Look for HTTP errors such as HTTP 429 (Too Many Requests), depending on the service.</span></span>
- <span data-ttu-id="c2106-534">HTTP 佇列長度增加。</span><span class="sxs-lookup"><span data-stu-id="c2106-534">HTTP queue length grows.</span></span>

<span data-ttu-id="c2106-535">**復原：**</span><span class="sxs-lookup"><span data-stu-id="c2106-535">**Recovery:**</span></span>

- <span data-ttu-id="c2106-536">相應放大以處理增加的負載。</span><span class="sxs-lookup"><span data-stu-id="c2106-536">Scale out to handle increased load.</span></span>
- <span data-ttu-id="c2106-537">降低失敗風險，以免連鎖性失敗中斷整個應用程式。</span><span class="sxs-lookup"><span data-stu-id="c2106-537">Mitigate failures to avoid having cascading failures disrupt the entire application.</span></span> <span data-ttu-id="c2106-538">風險降低策略包括：</span><span class="sxs-lookup"><span data-stu-id="c2106-538">Mitigation strategies include:</span></span>

  - <span data-ttu-id="c2106-539">實作[節流模式][throttling-pattern]以免壓垮後端系統。</span><span class="sxs-lookup"><span data-stu-id="c2106-539">Implement the [Throttling pattern][throttling-pattern] to avoid overwhelming backend systems.</span></span>
  - <span data-ttu-id="c2106-540">使用[佇列型負載調節][queue-based-load-leveling]為要求提供緩衝，並以適當步調處理這些要求。</span><span class="sxs-lookup"><span data-stu-id="c2106-540">Use [queue-based load leveling][queue-based-load-leveling] to buffer requests and process them at an appropriate pace.</span></span>
  - <span data-ttu-id="c2106-541">設定特定用戶端的優先順序。</span><span class="sxs-lookup"><span data-stu-id="c2106-541">Prioritize certain clients.</span></span> <span data-ttu-id="c2106-542">例如，如果應用程式有免費層與付費層，對免費層的客戶節流，但不要對付費客戶節流。</span><span class="sxs-lookup"><span data-stu-id="c2106-542">For example, if the application has free and paid tiers, throttle customers on the free tier, but not paid customers.</span></span> <span data-ttu-id="c2106-543">請參閱[優先順序佇列模式][priority-queue-pattern]。</span><span class="sxs-lookup"><span data-stu-id="c2106-543">See [Priority queue pattern][priority-queue-pattern].</span></span>

<span data-ttu-id="c2106-544">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-544">**Diagnostics**.</span></span> <span data-ttu-id="c2106-545">使用 [App Service 診斷記錄][app-service-logging]。</span><span class="sxs-lookup"><span data-stu-id="c2106-545">Use [App Service diagnostic logging][app-service-logging].</span></span> <span data-ttu-id="c2106-546">使用 [Azure Log Analytics][azure-log-analytics]、[Application Insights][app-insights] 或 [New Relic][new-relic] 等服務，以協助了解診斷記錄。</span><span class="sxs-lookup"><span data-stu-id="c2106-546">Use a service such as [Azure Log Analytics][azure-log-analytics], [Application Insights][app-insights], or [New Relic][new-relic] to help understand the diagnostic logs.</span></span>

### <a name="one-of-the-operations-in-a-workflow-or-distributed-transaction-fails"></a><span data-ttu-id="c2106-547">工作流程或分散式交易中的其中一個作業失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-547">One of the operations in a workflow or distributed transaction fails.</span></span>

<span data-ttu-id="c2106-548">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-548">**Detection**.</span></span> <span data-ttu-id="c2106-549">嘗試 N 次重試之後，作業仍失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-549">After *N* retry attempts, it still fails.</span></span>

<span data-ttu-id="c2106-550">**復原：**</span><span class="sxs-lookup"><span data-stu-id="c2106-550">**Recovery:**</span></span>

- <span data-ttu-id="c2106-551">作為風險降低計畫，請實作[排程器代理程式監督員][scheduler-agent-supervisor]模式以管理整個工作流程。</span><span class="sxs-lookup"><span data-stu-id="c2106-551">As a mitigation plan, implement the [Scheduler Agent Supervisor][scheduler-agent-supervisor] pattern to manage the entire workflow.</span></span>
- <span data-ttu-id="c2106-552">請不要在逾時的時候重試。</span><span class="sxs-lookup"><span data-stu-id="c2106-552">Don't retry on timeouts.</span></span> <span data-ttu-id="c2106-553">此錯誤的成功率很低。</span><span class="sxs-lookup"><span data-stu-id="c2106-553">There is a low success rate for this error.</span></span>
- <span data-ttu-id="c2106-554">將工作排入佇列，以便稍後重試。</span><span class="sxs-lookup"><span data-stu-id="c2106-554">Queue work, in order to retry later.</span></span>

<span data-ttu-id="c2106-555">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-555">**Diagnostics**.</span></span> <span data-ttu-id="c2106-556">記錄所有作業 (成功與失敗)，包括補償動作。</span><span class="sxs-lookup"><span data-stu-id="c2106-556">Log all operations (successful and failed), including compensating actions.</span></span> <span data-ttu-id="c2106-557">使用相互關聯識別碼，以便追蹤相同交易內的所有作業。</span><span class="sxs-lookup"><span data-stu-id="c2106-557">Use correlation IDs, so that you can track all operations within the same transaction.</span></span>

### <a name="a-call-to-a-remote-service-fails"></a><span data-ttu-id="c2106-558">遠端服務的呼叫失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-558">A call to a remote service fails.</span></span>

<span data-ttu-id="c2106-559">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="c2106-559">**Detection**.</span></span> <span data-ttu-id="c2106-560">HTTP 錯誤碼。</span><span class="sxs-lookup"><span data-stu-id="c2106-560">HTTP error code.</span></span>

<span data-ttu-id="c2106-561">**復原：**</span><span class="sxs-lookup"><span data-stu-id="c2106-561">**Recovery:**</span></span>

1. <span data-ttu-id="c2106-562">重試暫時性失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-562">Retry on transient failures.</span></span>
2. <span data-ttu-id="c2106-563">如果呼叫在嘗試 N 次之後失敗，請採取遞補動作。</span><span class="sxs-lookup"><span data-stu-id="c2106-563">If the call fails after *N* attempts, take a fallback action.</span></span> <span data-ttu-id="c2106-564">(應用程式所特有)。</span><span class="sxs-lookup"><span data-stu-id="c2106-564">(Application specific.)</span></span>
3. <span data-ttu-id="c2106-565">實作[斷路器模式][circuit-breaker]，以免發生連鎖性失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-565">Implement the [Circuit Breaker pattern][circuit-breaker] to avoid cascading failures.</span></span>

<span data-ttu-id="c2106-566">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="c2106-566">**Diagnostics**.</span></span> <span data-ttu-id="c2106-567">記錄所有遠端呼叫的失敗。</span><span class="sxs-lookup"><span data-stu-id="c2106-567">Log all remote call failures.</span></span>

## <a name="next-steps"></a><span data-ttu-id="c2106-568">後續步驟</span><span class="sxs-lookup"><span data-stu-id="c2106-568">Next steps</span></span>

<span data-ttu-id="c2106-569">如需 FMA 程序的詳細資訊，請參閱[雲端服務原本就有的復原功能設計][resilience-by-design-pdf] (PDF 下載)。</span><span class="sxs-lookup"><span data-stu-id="c2106-569">For more information about the FMA process, see [Resilience by design for cloud services][resilience-by-design-pdf] (PDF download).</span></span>
