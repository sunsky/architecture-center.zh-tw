...
- <span data-ttu-id="9d8e8-137">如果是預期性關閉，請使用應用程式的關閉事件來正常關閉。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-137">If the shutdown was expected, use the application's shutdown event to shut down gracefully.</span></span> <span data-ttu-id="9d8e8-138">例如，在 ASP.NET 中使用 `Application_End` 方法。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-138">For example, in ASP.NET, use the `Application_End` method.</span></span>
...
<span data-ttu-id="9d8e8-156">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-156">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-157">記錄所有驗證要求。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-157">Log all authentication requests.</span></span>
...
<span data-ttu-id="9d8e8-174">**復原：**</span><span class="sxs-lookup"><span data-stu-id="9d8e8-174">**Recovery:**</span></span>
...
<span data-ttu-id="9d8e8-192">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-192">**Detection**.</span></span> <span data-ttu-id="9d8e8-193">捕捉 `Microsoft.Rest.Azure.CloudException` 錯誤。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-193">Catch `Microsoft.Rest.Azure.CloudException` errors.</span></span>
...
<span data-ttu-id="9d8e8-215">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-215">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-216">應用程式記錄檔</span><span class="sxs-lookup"><span data-stu-id="9d8e8-216">Application logs</span></span>
...
<span data-ttu-id="9d8e8-262">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-262">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-263">記錄用戶端上的所有錯誤。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-263">Log all errors on the client side.</span></span>
...
- <span data-ttu-id="9d8e8-280">使用重試機制。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-280">Use a retry mechanism.</span></span> <span data-ttu-id="9d8e8-281">每個用戶端都有自己的重試原則。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-281">Each client has its own retry policies.</span></span>
...
<span data-ttu-id="9d8e8-316">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-316">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-317">使用 [Redis 快取診斷][redis-monitor]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-317">Use [Redis Cache diagnostics][redis-monitor].</span></span>
...
- <span data-ttu-id="9d8e8-334">若為查詢，讀取次要複本。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-334">For queries, read from a secondary replica.</span></span>
...
### <a name="writing-a-message-to-a-service-bus-queue-fails"></a><span data-ttu-id="9d8e8-376">將訊息寫入服務匯流排佇列時失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-376">Writing a message to a Service Bus queue fails.</span></span>
...
<span data-ttu-id="9d8e8-419">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-419">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-420">記錄重複的訊息。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-420">Log duplicated messages.</span></span>
...
<span data-ttu-id="9d8e8-439">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-439">**Detection**.</span></span> <span data-ttu-id="9d8e8-440">服務會傳回錯誤。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-440">The service returns an error.</span></span>
...
### <a name="writing-data-to-azure-storage-fails"></a><span data-ttu-id="9d8e8-461">將資料寫入 Azure 儲存體時失敗</span><span class="sxs-lookup"><span data-stu-id="9d8e8-461">Writing data to Azure Storage fails</span></span>
...
<span data-ttu-id="9d8e8-485">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-485">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-486">使用[儲存體度量][storage-metrics]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-486">Use [storage metrics][storage-metrics].</span></span>
...
<span data-ttu-id="9d8e8-489">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-489">**Detection**.</span></span> <span data-ttu-id="9d8e8-490">網路連線錯誤。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-490">Network connection errors.</span></span>

<span data-ttu-id="9d8e8-491">**復原：**</span><span class="sxs-lookup"><span data-stu-id="9d8e8-491">**Recovery:**</span></span>

- <span data-ttu-id="9d8e8-492">於負載平衡器後方，在可用性設定組內部署至少兩個後端 VM。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-492">Deploy at least two backend VMs in an availability set, behind a load balancer.</span></span>
- <span data-ttu-id="9d8e8-493">如果是暫時性的連線錯誤，有時 TCP 會成功地重試傳送訊息。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-493">If the connection error is transient, sometimes TCP will successfully retry sending the message.</span></span>
- <span data-ttu-id="9d8e8-494">在應用程式中實作重試原則。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-494">Implement a retry policy in the application.</span></span>
- <span data-ttu-id="9d8e8-495">若為持續性錯誤或非暫時性的錯誤，請實作[斷路器][circuit-breaker]模式。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-495">For persistent or non-transient errors, implement the [Circuit Breaker][circuit-breaker] pattern.</span></span>
- <span data-ttu-id="9d8e8-496">如果呼叫端 VM 超出其網路輸出限制，則輸出佇列會滿溢。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-496">If the calling VM exceeds its network egress limit, the outbound queue will fill up.</span></span> <span data-ttu-id="9d8e8-497">如果輸出佇列一直滿溢，請考慮相應放大。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-497">If the outbound queue is consistently full, consider scaling out.</span></span>

<span data-ttu-id="9d8e8-498">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-498">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-499">記錄服務界限上的事件。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-499">Log events at service boundaries.</span></span>

### <a name="vm-instance-becomes-unavailable-or-unhealthy"></a><span data-ttu-id="9d8e8-500">VM 執行個體變得無法使用或狀況不良。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-500">VM instance becomes unavailable or unhealthy.</span></span>

<span data-ttu-id="9d8e8-501">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-501">**Detection**.</span></span> <span data-ttu-id="9d8e8-502">設定負載平衡器[健康情況探查][lb-probe]，以指出 VM 執行個體是否狀況良好。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-502">Configure a Load Balancer [health probe][lb-probe] that signals whether the VM instance is healthy.</span></span> <span data-ttu-id="9d8e8-503">探查應該檢查重大功能是否會正確回應。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-503">The probe should check whether critical functions are responding correctly.</span></span>

<span data-ttu-id="9d8e8-504">**復原**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-504">**Recovery**.</span></span> <span data-ttu-id="9d8e8-505">對每個應用程式層，在相同的可用性設定組內放入多個 VM 執行個體，並在 VM 前放置負載平衡器。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-505">For each application tier, put multiple VM instances into the same availability set, and place a load balancer in front of the VMs.</span></span> <span data-ttu-id="9d8e8-506">如果健康情況探查失敗，負載平衡器會停止傳送新的連線至狀況不良的執行個體。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-506">If the health probe fails, the Load Balancer stops sending new connections to the unhealthy instance.</span></span>

<span data-ttu-id="9d8e8-507">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-507">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-508">- 使用負載平衡器[記錄分析][lb-monitor]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-508">- Use Load Balancer [log analytics][lb-monitor].</span></span>

- <span data-ttu-id="9d8e8-509">設定您的監視系統來監視所有的健康情況監視端點。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-509">Configure your monitoring system to monitor all of the health monitoring endpoints.</span></span>

### <a name="operator-accidentally-shuts-down-a-vm"></a><span data-ttu-id="9d8e8-510">操作員不小心關閉 VM。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-510">Operator accidentally shuts down a VM.</span></span>

<span data-ttu-id="9d8e8-511">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-511">**Detection**.</span></span> <span data-ttu-id="9d8e8-512">N/A</span><span class="sxs-lookup"><span data-stu-id="9d8e8-512">N/A</span></span>

<span data-ttu-id="9d8e8-513">**復原**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-513">**Recovery**.</span></span> <span data-ttu-id="9d8e8-514">使用 `ReadOnly` 層級設定資源鎖定。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-514">Set a resource lock with `ReadOnly` level.</span></span> <span data-ttu-id="9d8e8-515">請參閱[使用 Azure Resource Manager 鎖定資源][rm-locks]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-515">See [Lock resources with Azure Resource Manager][rm-locks].</span></span>

<span data-ttu-id="9d8e8-516">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-516">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-517">使用 [Azure 活動記錄][azure-activity-logs]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-517">Use [Azure Activity Logs][azure-activity-logs].</span></span>

## <a name="webjobs"></a><span data-ttu-id="9d8e8-518">WebJobs</span><span class="sxs-lookup"><span data-stu-id="9d8e8-518">WebJobs</span></span>

### <a name="continuous-job-stops-running-when-the-scm-host-is-idle"></a><span data-ttu-id="9d8e8-519">SCM 主機閒置時，連續作業停止執行。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-519">Continuous job stops running when the SCM host is idle.</span></span>

<span data-ttu-id="9d8e8-520">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-520">**Detection**.</span></span> <span data-ttu-id="9d8e8-521">將取消權杖傳遞給 WebJob 函式。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-521">Pass a cancellation token to the WebJob function.</span></span> <span data-ttu-id="9d8e8-522">如需詳細資訊，請參閱[正常關機][web-jobs-shutdown]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-522">For more information, see [Graceful shutdown][web-jobs-shutdown].</span></span>

<span data-ttu-id="9d8e8-523">**復原**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-523">**Recovery**.</span></span> <span data-ttu-id="9d8e8-524">在 Web 應用程式中啟用 `Always On` 設定。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-524">Enable the `Always On` setting in the web app.</span></span> <span data-ttu-id="9d8e8-525">如需詳細資訊，請參閱[使用 WebJobs 執行背景工作][web-jobs]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-525">For more information, see [Run Background tasks with WebJobs][web-jobs].</span></span>

## <a name="application-design"></a><span data-ttu-id="9d8e8-526">應用程式設計</span><span class="sxs-lookup"><span data-stu-id="9d8e8-526">Application design</span></span>

### <a name="application-cant-handle-a-spike-in-incoming-requests"></a><span data-ttu-id="9d8e8-527">應用程式無法處理內送要求突然增加。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-527">Application can't handle a spike in incoming requests.</span></span>

<span data-ttu-id="9d8e8-528">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-528">**Detection**.</span></span> <span data-ttu-id="9d8e8-529">視應用程式而定。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-529">Depends on the application.</span></span> <span data-ttu-id="9d8e8-530">一般徵兆：</span><span class="sxs-lookup"><span data-stu-id="9d8e8-530">Typical symptoms:</span></span>

- <span data-ttu-id="9d8e8-531">網站開始傳回 HTTP 5xx 錯誤碼。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-531">The website starts returning HTTP 5xx error codes.</span></span>
- <span data-ttu-id="9d8e8-532">相依服務 (例如資料庫或儲存體) 開始對要求進行節流。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-532">Dependent services, such as database or storage, start to throttle requests.</span></span> <span data-ttu-id="9d8e8-533">根據服務尋找 HTTP 錯誤，例如 HTTP 429 (太多要求)。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-533">Look for HTTP errors such as HTTP 429 (Too Many Requests), depending on the service.</span></span>
- <span data-ttu-id="9d8e8-534">HTTP 佇列長度增加。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-534">HTTP queue length grows.</span></span>

<span data-ttu-id="9d8e8-535">**復原：**</span><span class="sxs-lookup"><span data-stu-id="9d8e8-535">**Recovery:**</span></span>

- <span data-ttu-id="9d8e8-536">相應放大以處理增加的負載。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-536">Scale out to handle increased load.</span></span>
- <span data-ttu-id="9d8e8-537">降低失敗風險，以免連鎖性失敗中斷整個應用程式。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-537">Mitigate failures to avoid having cascading failures disrupt the entire application.</span></span> <span data-ttu-id="9d8e8-538">風險降低策略包括：</span><span class="sxs-lookup"><span data-stu-id="9d8e8-538">Mitigation strategies include:</span></span>

  - <span data-ttu-id="9d8e8-539">實作[節流模式][throttling-pattern]以免壓垮後端系統。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-539">Implement the [Throttling pattern][throttling-pattern] to avoid overwhelming backend systems.</span></span>
  - <span data-ttu-id="9d8e8-540">使用[佇列型負載調節][queue-based-load-leveling]為要求提供緩衝，並以適當步調處理這些要求。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-540">Use [queue-based load leveling][queue-based-load-leveling] to buffer requests and process them at an appropriate pace.</span></span>
  - <span data-ttu-id="9d8e8-541">設定特定用戶端的優先順序。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-541">Prioritize certain clients.</span></span> <span data-ttu-id="9d8e8-542">例如，如果應用程式有免費層與付費層，對免費層的客戶節流，但不要對付費客戶節流。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-542">For example, if the application has free and paid tiers, throttle customers on the free tier, but not paid customers.</span></span> <span data-ttu-id="9d8e8-543">請參閱[優先順序佇列模式][priority-queue-pattern]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-543">See [Priority queue pattern][priority-queue-pattern].</span></span>

<span data-ttu-id="9d8e8-544">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-544">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-545">使用 [App Service 診斷記錄][app-service-logging]。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-545">Use [App Service diagnostic logging][app-service-logging].</span></span> <span data-ttu-id="9d8e8-546">使用 [Azure Log Analytics][azure-log-analytics]、[Application Insights][app-insights] 或 [New Relic][new-relic] 等服務，以協助了解診斷記錄。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-546">Use a service such as [Azure Log Analytics][azure-log-analytics], [Application Insights][app-insights], or [New Relic][new-relic] to help understand the diagnostic logs.</span></span>

### <a name="one-of-the-operations-in-a-workflow-or-distributed-transaction-fails"></a><span data-ttu-id="9d8e8-547">工作流程或分散式交易中的其中一個作業失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-547">One of the operations in a workflow or distributed transaction fails.</span></span>

<span data-ttu-id="9d8e8-548">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-548">**Detection**.</span></span> <span data-ttu-id="9d8e8-549">嘗試 N 次重試之後，作業仍失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-549">After *N* retry attempts, it still fails.</span></span>

<span data-ttu-id="9d8e8-550">**復原：**</span><span class="sxs-lookup"><span data-stu-id="9d8e8-550">**Recovery:**</span></span>

- <span data-ttu-id="9d8e8-551">作為風險降低計畫，請實作[排程器代理程式監督員][scheduler-agent-supervisor]模式以管理整個工作流程。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-551">As a mitigation plan, implement the [Scheduler Agent Supervisor][scheduler-agent-supervisor] pattern to manage the entire workflow.</span></span>
- <span data-ttu-id="9d8e8-552">請不要在逾時的時候重試。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-552">Don't retry on timeouts.</span></span> <span data-ttu-id="9d8e8-553">此錯誤的成功率很低。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-553">There is a low success rate for this error.</span></span>
- <span data-ttu-id="9d8e8-554">將工作排入佇列，以便稍後重試。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-554">Queue work, in order to retry later.</span></span>

<span data-ttu-id="9d8e8-555">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-555">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-556">記錄所有作業 (成功與失敗)，包括補償動作。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-556">Log all operations (successful and failed), including compensating actions.</span></span> <span data-ttu-id="9d8e8-557">使用相互關聯識別碼，以便追蹤相同交易內的所有作業。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-557">Use correlation IDs, so that you can track all operations within the same transaction.</span></span>

### <a name="a-call-to-a-remote-service-fails"></a><span data-ttu-id="9d8e8-558">遠端服務的呼叫失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-558">A call to a remote service fails.</span></span>

<span data-ttu-id="9d8e8-559">**偵測**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-559">**Detection**.</span></span> <span data-ttu-id="9d8e8-560">HTTP 錯誤碼。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-560">HTTP error code.</span></span>

<span data-ttu-id="9d8e8-561">**復原：**</span><span class="sxs-lookup"><span data-stu-id="9d8e8-561">**Recovery:**</span></span>

1. <span data-ttu-id="9d8e8-562">重試暫時性失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-562">Retry on transient failures.</span></span>
2. <span data-ttu-id="9d8e8-563">如果呼叫在嘗試 N 次之後失敗，請採取遞補動作。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-563">If the call fails after *N* attempts, take a fallback action.</span></span> <span data-ttu-id="9d8e8-564">(應用程式所特有)。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-564">(Application specific.)</span></span>
3. <span data-ttu-id="9d8e8-565">實作[斷路器模式][circuit-breaker]，以免發生連鎖性失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-565">Implement the [Circuit Breaker pattern][circuit-breaker] to avoid cascading failures.</span></span>

<span data-ttu-id="9d8e8-566">**診斷**。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-566">**Diagnostics**.</span></span> <span data-ttu-id="9d8e8-567">記錄所有遠端呼叫的失敗。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-567">Log all remote call failures.</span></span>

## <a name="next-steps"></a><span data-ttu-id="9d8e8-568">後續步驟</span><span class="sxs-lookup"><span data-stu-id="9d8e8-568">Next steps</span></span>

<span data-ttu-id="9d8e8-569">如需 FMA 程序的詳細資訊，請參閱[雲端服務原本就有的復原功能設計][resilience-by-design-pdf] (PDF 下載)。</span><span class="sxs-lookup"><span data-stu-id="9d8e8-569">For more information about the FMA process, see [Resilience by design for cloud services][resilience-by-design-pdf] (PDF download).</span></span>
