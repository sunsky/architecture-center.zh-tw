            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Azure 上的高效能運算 (HPC)</h3>
                            <p>在 Azure 上建置高效能運算 (HPC) 應用程式的設計指引和元件資訊。</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Azure 虛擬資料中心</h3>
                            <p>組織在將企業工作負載部署到雲端時，必須在治理及開發人員敏捷度之間取得平衡。 Azure 虛擬資料中心提供模型來達成這項平衡且著重治理。</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>提交對 Architecture Center 的構想</h3>
                            <p>您對新的架構或設計文件有任何構想嗎？</p>
                            <p>您希望在 Azure 架構中心看到哪些類型的文章？</p>
                        </div>
                    </div>
                </div>
            </div>
