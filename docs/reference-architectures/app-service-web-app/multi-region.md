...
## <a name="availability-considerations---traffic-manager"></a>可用性考量 - 流量管理員
...
## <a name="availability-considerations---storage"></a>可用性考量 - 儲存體
...
## <a name="manageability-considerations---traffic-manager"></a>管理性考量 - 流量管理員
...
## <a name="manageability-considerations---sql-database"></a>管理性考量 - SQL Database
